...
int main() 
{
    ...
    // АСМ медленнее получился, потому что компиляторы щас не пальцем деланные, они сами уже более
    // оптимизированной код генерируют ассемблеровский, нежели чем мы напишем
}